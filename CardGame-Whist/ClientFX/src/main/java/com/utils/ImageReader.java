...
public class ImageReader {
    ...
    public ImageReader() throws IOException {
        File f = new File("C:\\GitProjects\\whistGame\\CardGame-Whist\\ClientFX\\src\\main\\resources\\images\\cards.png");
    ...
    private void getSubImages() throws IOException {
        ...
        BufferedImage bufferedImage1 = ImageIO.read(new File("C:\\GitProjects\\whistGame\\CardGame-Whist\\ClientFX\\src\\main\\resources\\images\\1-back (1).png"));
        BufferedImage bufferedImage2 = ImageIO.read(new File("C:\\GitProjects\\whistGame\\CardGame-Whist\\ClientFX\\src\\main\\resources\\images\\2-back (1).png"));
        BufferedImage bufferedImage3 = ImageIO.read(new File("C:\\GitProjects\\whistGame\\CardGame-Whist\\ClientFX\\src\\main\\resources\\images\\3-back.png"));
        BufferedImage bufferedImage4 = ImageIO.read(new File("C:\\GitProjects\\whistGame\\CardGame-Whist\\ClientFX\\src\\main\\resources\\images\\4-back (1).png"));
        BufferedImage bufferedImage5 = ImageIO.read(new File("C:\\GitProjects\\whistGame\\CardGame-Whist\\ClientFX\\src\\main\\resources\\images\\5-back.png"));
        BufferedImage bufferedImage6 = ImageIO.read(new File("C:\\GitProjects\\whistGame\\CardGame-Whist\\ClientFX\\src\\main\\resources\\images\\6-back (1).png"));
